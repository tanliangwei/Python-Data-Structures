...
### Time Complexity
The time complexity of BFS is O(|V|+|E|) which is also equal to  <math><mn>1</mn><mo>+</mo><mn>1</mn></math> where b is the branching factor and d is the depth of the graph.
